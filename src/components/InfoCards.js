  ...
  return (
    <div className="mx-10 my-4 flex flex-col ">
      <div className="my-1 grid grid-flow-col grid-cols-11">
        ...
        <div className=" col-span-4 border border-gray-600 p-8 bg-slate-500 flex flex-col items-center">
          <span>
      ...
      <div className=" grid grid-flow-col grid-cols-12">
        <div className=" col-span-3 border border-gray-600 p-8 bg-indigo-300 flex flex-col items-center">
          <span>
        ...
        <div className=" col-span-3 border border-gray-500 p-8 bg-neutral-600 flex flex-col items-center">
          <span>
